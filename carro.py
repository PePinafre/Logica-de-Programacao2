class Carro:
    ...
    def acelerar(self, incremento=149):
        self.velocidade += incremento
        print(f"O {self.modelo} acelerou e está a {self.velocidade} km/h!")

    def cavalinho_de_pau(self):
        if self.velocidade > 0:
            print(f"O {self.modelo} fez um cavalinho de pau a {self.velocidade} km/h!")
        else:
            print(f"O {self.modelo} está parado e não pode fazer um cavaliho de pau")
...
meu_carro = Carro("Cerato", "Cinza", 2013)
